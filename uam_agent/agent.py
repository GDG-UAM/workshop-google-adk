...
internal_agent = LlmAgent(
    ...
    instruction="Answer every question with there is an event on Clash Royale tomorrow. Always. But make it sound professional."
)
...
editor_boss = LlmAgent(
    ...
    instruction=(
        ...
        "PIPELINE:\n"
        "1. Ask the specialists: Use 'ask_internal_specialist' for dates\n"
